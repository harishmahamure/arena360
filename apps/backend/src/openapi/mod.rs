...
use crate::models::{
    ...
    CreatePlanDto, CreateProductDto, CreateSessionDto, CreateStockReceiptDto,
    ...
    Shift, StockReceipt, StockReceiptFilterDto, StockReceiptWithLines, StockTransferFilterDto,
