...
use crate::models::{
    ...
    normalize_payment_method, normalize_payment_status,
    normalize_plan_type, normalize_product_category, normalize_transaction_type,
    normalize_unit_type, DEVICE_STATUSES, PAYMENT_METHODS, PAYMENT_STATUSES, PLAN_TYPES_DB,
    PRODUCT_CATEGORIES, TRANSACTION_TYPES, UNIT_TYPES,
};
...
pub fn require_device_type(value: Option<String>) -> Result<String, AppError> {
    ...
    normalize_device_type(&raw)
        .ok_or_else(|| AppError::BadRequest(device_type_error_message()))
}
...
pub fn optional_device_sub_type(value: Option<String>) -> Result<Option<String>, AppError> {
    optional_enum(value, normalize_device_sub_type, device_sub_type_error_message)
}

pub fn optional_device_status(value: Option<String>) -> Result<Option<String>, AppError> {
    optional_enum(value, normalize_device_status, || enum_error_message("status", DEVICE_STATUSES))
}
...
pub fn optional_unit_type(value: Option<String>) -> Result<Option<String>, AppError> {
    optional_enum(value, normalize_unit_type, || enum_error_message("type", UNIT_TYPES))
}
...
pub fn optional_plan_type(value: Option<String>) -> Result<Option<String>, AppError> {
    optional_enum(value, normalize_plan_type, || enum_error_message("planType", PLAN_TYPES_DB))
}
...
pub fn require_transaction_type(value: Option<String>) -> Result<String, AppError> {
    ...
    normalize_transaction_type(&raw)
        .ok_or_else(|| AppError::BadRequest(enum_error_message("transactionType", TRANSACTION_TYPES)))
}
